@extends('layouts.app', ['activePage' => 'table', 'titlePage' => __('Table Events')])
        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <button type="button" class="btn btn-info"><i class="fa fa-plus"></i> <a href="{{ route('request') }}">Add New Request</a></button>
                    </div>
                </div>
            </div>
...
<tr>
    ...
    <td>{{ $ev -> begin_at }}</td>
    <td>{{ $ev -> end_at }}</td>
    <td>{{ $ev -> event_address }}</td>
    <td>{{ $ev -> event_email }}</td>
    <td>{{ $ev -> event_phone }}</td>
    <td>{{ $ev -> flyer_link }}</td>
    <td>{{ $ev -> id }}</td>
    <td>{{ $ev -> visibility }}</td>
    <th> Accepté </th>
