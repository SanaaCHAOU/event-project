																		...
																		<table border="0" style="max-width: 100%;">
																			<tr>
																				<td class="textContent">
																					<h3 style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Our response</h3>
																					<div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">our event planning platform is meant for different purposes. They can aim to inform, to enable the exchange of knowledge, to encourage networking, to motivate or thank existing staff, or to strengthen the team spirit among the organizers.
</div>
																				</td>
																			</tr>
																		</table>
															...
															<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																<tr>
																	<td align="center" valign="middle" class="buttonContent" style="padding-top:15px;padding-bottom:15px;padding-right:15px;padding-left:15px;">
																		<a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;" href="http://127.0.0.1:8000/login" target="_blank">Consulter</a>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
