...
<body>
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-lg-7">
          <div class="intro text-center">
            <h1 data-aos="fade-up" data-aos-delay="100">We Inspire You To Create A Great Events </h1>
            <div class="intro-desc" data-aos="fade-up" data-aos-delay="200"><p class="mb-4">You can achieve the same effect of the image background by visiting on <a href="https://duotone.shapefactory.co/" target="_blank">this link</a>. Far far away, behind the word mountains, far from the countries Vokalia</p>
         <!--     <p class="m-0" data-aos="fade-up" data-aos-delay="300"><a href="https://vimeo.com/342333493" data-fancybox class="play-btn">
  ...
  <div class="services-v1 bg-light">
    <div class="container">
      <div class="row">
      ...
      <div class="more-services" data-aos="fade-up" data-aos-delay="0">
      <a href="#" class="more">See Our Events --> </a>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-between">
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="0">
          <h3 class="heading">Why Are We Awesome?</h3>
          <div class="excerpt">
          <p>Far far away, behind the word mountains, far <span class="highlight">from the countries Vokalia and Consonantia</span>, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
  ...
  <div class="untree_co-section untree_co-hero pt-0">
    <div class="img-bg" style="background-image: url('{{ asset('FrontEnd')}}/images/bg_1.jpg')">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="contents" data-aos="fade-up">
              <h3 class="heading">Our Concept</h3>
              <p>Far far away, behind the word mountains, far <span class="highlight">from the countries Vokalia and Consonantia</span>, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>

              <p class="mb-4">A small river named <span class="highlight">Duden flows by their place and supplies it with the necessary regelialia</span>. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
              <p class="mb-0"><a href="#" class="btn btn-primary">Get started</a></p>
            </div> <!-- /.contents -->
          </div>
        </div>
      </div>
  ...
  <div class="untree_co-section pt-0">
    <div class="container-fluid text-center">
      ...
      <div class="owl-carousel owl-4-slider">
        ...
        <div class="untree_co-testimonial">
