 ...
 <nav class="site-nav dark mb-5">
    <div class="container">
      <div class="site-navigation">
        <a href="/index" class="logo m-0">Events App <span class="text-primary">.</span></a>
        ...
        <a href="#" class="burger ml-auto float-right site-menu-toggle js-menu-toggle d-inline-block d-lg-none blue" data-toggle="collapse" data-target="#main-navbar">
          <span></span>
        </a>
    ...
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-lg-7 pt-5 mt-5">
          <h1 class="text-black" data-aos="fade-up" data-aos-delay="100">Contact Us</h1>
